...
def RFU_Precondition(
    ...
    ResTable_dist = utils.ResTable_dist
    ResTable_vals = utils.ResTable_vals
    ...
    fac = jnp.where(
        ...
        (dist - dist_lower) / (dist_upper - dist_lower),
        0.0,
    )
    ...
    Imrr = jnp.array(
        [
            [
                jnp.ones(n_pairs_lub_prec),
                jnp.zeros(n_pairs_lub_prec),
                jnp.zeros(n_pairs_lub_prec),
            ],
            [
                jnp.zeros(n_pairs_lub_prec),
    ...
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[1, :]
    ].add(A_neigh[0, 0, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[1, :] + 1
    ].add(A_neigh[0, 1, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[1, :] + 2
    ].add(A_neigh[0, 2, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :] + 1, 6 * nl_lub_prec[1, :]
    ].add(A_neigh[1, 0, :])
    R_fu_precondition = R_fu_precondition.at[
    ...
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :] + 2, 6 * nl_lub_prec[1, :]
    ].add(A_neigh[2, 0, :])
    R_fu_precondition = R_fu_precondition.at[
    ...
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[1, :] + 3
    ].add(B_neigh[0, 0, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[1, :] + 4
    ].add(B_neigh[0, 1, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[1, :] + 5
    ].add(B_neigh[0, 2, :])
    R_fu_precondition = R_fu_precondition.at[
    ...
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :] + 3, 6 * nl_lub_prec[1, :]
    ].add(B_neigh[0, 0, :])
    R_fu_precondition = R_fu_precondition.at[
    ...
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :] + 4, 6 * nl_lub_prec[1, :]
    ].add(B_neigh[1, 0, :])
    R_fu_precondition = R_fu_precondition.at[
    ...
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :] + 5, 6 * nl_lub_prec[1, :]
    ].add(B_neigh[2, 0, :])
    R_fu_precondition = R_fu_precondition.at[
    ...
    # A11 Block
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[0, :]
    ].add(A_self[0, 0, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[0, :] + 1
    ].add(A_self[0, 1, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[0, :] + 2
    ].add(A_self[0, 2, :])
    R_fu_precondition = R_fu_precondition.at[
    ...
    # A22 Block
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[1, :], 6 * nl_lub_prec[1, :]
    ].add(A_self[0, 0, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[1, :], 6 * nl_lub_prec[1, :] + 1
    ].add(A_self[0, 1, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[1, :], 6 * nl_lub_prec[1, :] + 2
    ].add(A_self[0, 2, :])
    R_fu_precondition = R_fu_precondition.at[
    ...
    # Bt11 Block
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[0, :] + 3
    ].add(-B_self[0, 0, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[0, :] + 4
    ].add(-B_self[0, 1, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[0, :], 6 * nl_lub_prec[0, :] + 5
    ].add(-B_self[0, 2, :])
    R_fu_precondition = R_fu_precondition.at[
    ...
    # Bt22 Block
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[1, :], 6 * nl_lub_prec[1, :] + 3
    ].add(B_self[0, 0, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[1, :], 6 * nl_lub_prec[1, :] + 4
    ].add(B_self[0, 1, :])
    R_fu_precondition = R_fu_precondition.at[
        6 * nl_lub_prec[1, :], 6 * nl_lub_prec[1, :] + 5
    ].add(B_self[0, 2, :])
    R_fu_precondition = R_fu_precondition.at[
    ...
    diagonal_elements_for_brownian = jnp.where(
        (diagonal_elements >= 1) | (diagonal_elements == 0),
        1,
        jnp.sqrt(1 / diagonal_elements),
...
def ComputeLubricationFU(
    velocities, indices_i_lub, indices_j_lub, ResFunctions, r_lub, N
):
...
def compute_RFE(
    ...
    l = YH11.at[:, None].get() * (2.0 * epsrdEdri.T) + YH21.at[:, None].get() * (
        2.0 * epsrdEdri.T
    )
...
def compute_RSU(
    stresslet, velocities, indices_i_lub, indices_j_lub, ResFunctions, r_lub, N
):
