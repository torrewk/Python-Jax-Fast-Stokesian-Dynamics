...
def compute_real_space_slipvelocity(
    ...
    def helper_compute_M12psi(
            n_iter_Lanczos_ff: int, 
            tridiagonal: ArrayLike, 
            vectors: ArrayLike,
            norm: float) -> ArrayLike:
...
def compute_real_space_slipvelocity_open(
        ...
        indices_i: ArrayLike,
        indices_j: ArrayLike,
        mobil_scal: ArrayLike) -> tuple[Array,float,Array]:
...
def compute_nearfield_brownianforce(
    ...
    def Precondition_Inn_kernel( ###
            x: ArrayLike,
            diagonal_zeroes_for_brownian: ArrayLike) -> ArrayLike:
        ...
        identity = jnp.where((jnp.arange(6*N)-6*(jnp.repeat(jnp.arange(N), 6))) < 3, 1, 1.333333333)
    ...
    def Precondition_Brownian_RFUmultiply( 
            psi: ArrayLike) -> ArrayLike:
    ...
    def Precondition_Brownian_Undo(
            nf_Brownian_force: ArrayLike) -> ArrayLike:
    ...
    def ComputeLubricationFU(
            velocities: ArrayLike) -> ArrayLike:
    ...
    def helper_compute_R12psi(
            n_iter_Lanczos_nf: ArrayLike,
            trid: ArrayLike,
            vectors: ArrayLike) -> ArrayLike:
