        ...
        for j in range(Ny):
            for k in range(Nz):
                ...
                if (
                    ...
                    ii_nyquist = (i == int(Nx / 2)) and (
                        int(Nx / 2) == int((Nx + 1) / 2)
                    )
                    jj_nyquist = (j == int(Ny / 2)) and (
                        int(Ny / 2) == int((Ny + 1) / 2)
                    )
                    kk_nyquist = (k == int(Nz / 2)) and (
                        int(Nz / 2) == int((Nz + 1) / 2)
                    )
                    if (
...
def compute_real_space_slipvelocity(
    ...
    def helper_Mpsi(random_array):
        ...
        couplets = couplets.at[::8].add(
            random_array.at[(3 * N + 3) :: 8].get()
        )  # C[0] = S[0]
        couplets = couplets.at[1::8].add(
            random_array.at[(3 * N + 4) :: 8].get()
            + random_array.at[(3 * N + 2) :: 8].get() * 0.5
        )  # C[1] = S[1] + L[2]/2
        couplets = couplets.at[2::8].add(
            random_array.at[(3 * N + 5) :: 8].get()
            - random_array.at[(3 * N + 1) :: 8].get() * 0.5
        )  # C[2] = S[2] - L[1]/2
        couplets = couplets.at[3::8].add(
            random_array.at[(3 * N + 6) :: 8].get()
            + random_array.at[(3 * N + 0) :: 8].get() * 0.5
        )  # C[3] = S[3] + L[0]/2
        couplets = couplets.at[4::8].add(
            random_array.at[(3 * N + 7) :: 8].get()
        )  # C[4] = S[4]
        ...
        r_lin_velocities = r_lin_velocities.at[indices_i, 1].add(
            f1 * forces.at[3 * indices_j + 1].get()
            + (f2 - f1) * rdotf_j * r.at[:, 1].get()
        )
        r_lin_velocities = r_lin_velocities.at[indices_i, 2].add(
            f1 * forces.at[3 * indices_j + 2].get()
            + (f2 - f1) * rdotf_j * r.at[:, 2].get()
        )
        r_lin_velocities = r_lin_velocities.at[indices_i, 0].add(
        ...
        r_lin_velocities = r_lin_velocities.at[indices_j, 0].add(
            f1 * forces.at[3 * indices_i].get()
            - (f2 - f1) * mrdotf_i * r.at[:, 0].get()
        )
        r_lin_velocities = r_lin_velocities.at[indices_j, 1].add(
            f1 * forces.at[3 * indices_i + 1].get()
            - (f2 - f1) * mrdotf_i * r.at[:, 1].get()
        )
        r_lin_velocities = r_lin_velocities.at[indices_j, 2].add(
            f1 * forces.at[3 * indices_i + 2].get()
            - (f2 - f1) * mrdotf_i * r.at[:, 2].get()
        )
        r_lin_velocities = r_lin_velocities.at[indices_j, 0].add(
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_i, 0].add(
            ...
            * (
                couplets.at[8 * indices_j + 0].get()
                - 4.0 * couplets.at[8 * indices_j + 0].get()
            )
            + h2
            * (
                r.at[:, 0].get() * Cj_dotr.at[0, :].get()
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_j, 0].add(
            ...
            * (
                couplets.at[8 * indices_i + 0].get()
                - 4.0 * couplets.at[8 * indices_i + 0].get()
            )
            + h2
            * (
                -r.at[:, 0].get() * Ci_dotmr.at[0, :].get()
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_i, 1].add(
            ...
            * (
                ...
                - 4.0 * couplets.at[8 * indices_j + 1].get()
            )
            + h2
            * (
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_j, 1].add(
            ...
            * (
                ...
                - 4.0 * couplets.at[8 * indices_i + 1].get()
            )
            + h2
            * (
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_i, 2].add(
            ...
            * (
                ...
                - 4.0 * couplets.at[8 * indices_j + 2].get()
            )
            + h2
            * (
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_j, 2].add(
            ...
            * (
                ...
                - 4.0 * couplets.at[8 * indices_i + 2].get()
            )
            + h2
            * (
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_i, 3].add(
            ...
            * (
                ...
                - 4.0 * couplets.at[8 * indices_j + 3].get()
            )
            + h2
            * (
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_j, 3].add(
            ...
            * (
                ...
                - 4.0 * couplets.at[8 * indices_i + 3].get()
            )
            + h2
            * (
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_i, 4].add(
            ...
            * (
                couplets.at[8 * indices_j + 4].get()
                - 4.0 * couplets.at[8 * indices_j + 4].get()
            )
            + h2
            * (
                r.at[:, 1].get() * Cj_dotr.at[1, :].get()
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_j, 4].add(
            ...
            * (
                couplets.at[8 * indices_i + 4].get()
                - 4.0 * couplets.at[8 * indices_i + 4].get()
            )
            + h2
            * (
                -r.at[:, 1].get() * Ci_dotmr.at[1, :].get()
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_i, 5].add(
            ...
            * (
                couplets.at[8 * indices_j + 1].get()
                - 4.0 * couplets.at[8 * indices_j + 5].get()
            )
            + h2
            * (
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_j, 5].add(
            ...
            * (
                couplets.at[8 * indices_i + 1].get()
                - 4.0 * couplets.at[8 * indices_i + 5].get()
            )
            + h2
            * (
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_i, 6].add(
            ...
            * (
                couplets.at[8 * indices_j + 2].get()
                - 4.0 * couplets.at[8 * indices_j + 6].get()
            )
            + h2
            * (
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_j, 6].add(
            ...
            * (
                couplets.at[8 * indices_i + 2].get()
                - 4.0 * couplets.at[8 * indices_i + 6].get()
            )
            + h2
            * (
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_i, 7].add(
            ...
            * (
                couplets.at[8 * indices_j + 3].get()
                - 4.0 * couplets.at[8 * indices_j + 7].get()
            )
            + h2
            * (
        ...
        r_velocity_gradient = r_velocity_gradient.at[indices_j, 7].add(
            ...
            * (
                couplets.at[8 * indices_i + 3].get()
                - 4.0 * couplets.at[8 * indices_i + 7].get()
            )
            + h2
            * (
        ...
        r_ang_vel_and_strain = r_ang_vel_and_strain.at[:, 1].add(
            (r_velocity_gradient.at[:, 6].get() - r_velocity_gradient.at[:, 2].get())
            * 0.5
        )
        ...
        slip_velocity = slip_velocity.at[: 3 * N].add(
            jnp.reshape(r_lin_velocities, 3 * N)
        )
        slip_velocity = slip_velocity.at[3 * N :].add(
            jnp.reshape(r_ang_vel_and_strain, 8 * N)
        )
    ...
    trid, vectors = lanczos.lanczos_alg(
        helper_Mpsi, 11 * N, n_iter_Lanczos_ff, random_array_real
    )
...
def compute_wave_space_slipvelocity(
    ...
    gridY = gridY.at[normal_indices_x, normal_indices_y, normal_indices_z].add(
        ...
        + 1j
        * random_array_wave.at[(3 * len_norm_indices) : (4 * len_norm_indices)].get()
    )
    gridY = gridY.at[
        normal_conj_indices_x, normal_conj_indices_y, normal_conj_indices_z
    ].add(
    ...
    gridZ = gridZ.at[normal_indices_x, normal_indices_y, normal_indices_z].add(
        ...
        + 1j
        * random_array_wave.at[(5 * len_norm_indices) : (6 * len_norm_indices)].get()
    )
    gridZ = gridZ.at[
        normal_conj_indices_x, normal_conj_indices_y, normal_conj_indices_z
    ].add(
    ...
    SD = jnp.where(
        gridk_mod > 0,
        3.0
        * (jnp.sin(gridk_mod) - gridk_mod * jnp.cos(gridk_mod))
        / (gridk_sqr * gridk_mod),
        0.0,
    )
...
def compute_nearfield_brownianforce(
    ...
    def Precondition_Brownian_Undo(nf_Brownian_force):
        ...
        return Precondition_ImInn_kernel(
            nf_Brownian_force, diagonal_zeroes_for_brownian
        )
    ...
    def helper_compute_R12psi(n_iter_Lanczos_nf, trid, vectors):
        ...
        a = jnp.where(
            a < 0.0, 0.0, a
        )  # numerical cutoff to avoid small negative values
        a = jnp.dot((jnp.dot(b, jnp.diag(jnp.sqrt(a)))), b.T)
...
def compute_exact_thermals(
    ...
    def helper_reshape(Mpsi):
        ...
        reshaped_array = reshaped_array.at[3 * N :].set(
            jnp.reshape(ang_vel_and_strain, 8 * N)
        )
    ...
    def GeneralizedMobility_ws(
        ...
        stresslet = stresslet.at[0::5].set(
            generalized_forces.at[(6 * N + 0) :: 5].get()
        )  # Sxx
        stresslet = stresslet.at[1::5].set(
            generalized_forces.at[(6 * N + 1) :: 5].get()
        )  # Sxy
        stresslet = stresslet.at[2::5].set(
            generalized_forces.at[(6 * N + 2) :: 5].get()
        )  # Sxz
        stresslet = stresslet.at[3::5].set(
            generalized_forces.at[(6 * N + 3) :: 5].get()
        )  # Syz
        stresslet = stresslet.at[4::5].set(
            generalized_forces.at[(6 * N + 4) :: 5].get()
        )  # Syy
                    ...
                    jnp.swapaxes(
                        jnp.swapaxes(
                            jnp.swapaxes(
                                gaussian_grid_spacing1
                                * jnp.resize(
                                    forces.at[0::3].get(), (gaussP, gaussP, gaussP, N)
                                ),
                                3,
                                2,
                            ),
                    ...
                    jnp.swapaxes(
                        jnp.swapaxes(
                            jnp.swapaxes(
                                gaussian_grid_spacing1
                                * jnp.resize(
                                    forces.at[1::3].get(), (gaussP, gaussP, gaussP, N)
                                ),
                                3,
                                2,
                            ),
                    ...
                    jnp.swapaxes(
                        jnp.swapaxes(
                            jnp.swapaxes(
                                gaussian_grid_spacing1
                                * jnp.resize(
                                    forces.at[2::3].get(), (gaussP, gaussP, gaussP, N)
                                ),
                                3,
                                2,
                            ),
                    ...
                    jnp.swapaxes(
                        jnp.swapaxes(
                            jnp.swapaxes(
                                gaussian_grid_spacing1
                                * jnp.resize(
                                    couplets.at[0::8].get(), (gaussP, gaussP, gaussP, N)
                                ),
                                3,
                                2,
                            ),
                    ...
                    jnp.swapaxes(
                        jnp.swapaxes(
                            jnp.swapaxes(
                                gaussian_grid_spacing1
                                * jnp.resize(
                                    couplets.at[1::8].get(), (gaussP, gaussP, gaussP, N)
                                ),
                                3,
                                2,
                            ),
                    ...
                    jnp.swapaxes(
                        jnp.swapaxes(
                            jnp.swapaxes(
                                gaussian_grid_spacing1
                                * jnp.resize(
                                    couplets.at[2::8].get(), (gaussP, gaussP, gaussP, N)
                                ),
                                3,
                                2,
                            ),
                    ...
                    jnp.swapaxes(
                        jnp.swapaxes(
                            jnp.swapaxes(
                                gaussian_grid_spacing1
                                * jnp.resize(
                                    couplets.at[3::8].get(), (gaussP, gaussP, gaussP, N)
                                ),
                                3,
                                2,
                            ),
                    ...
                    jnp.swapaxes(
                        jnp.swapaxes(
                            jnp.swapaxes(
                                gaussian_grid_spacing1
                                * jnp.resize(
                                    couplets.at[4::8].get(), (gaussP, gaussP, gaussP, N)
                                ),
                                3,
                                2,
                            ),
                    ...
                    jnp.swapaxes(
                        jnp.swapaxes(
                            jnp.swapaxes(
                                gaussian_grid_spacing1
                                * jnp.resize(
                                    couplets.at[5::8].get(), (gaussP, gaussP, gaussP, N)
                                ),
                                3,
                                2,
                            ),
                    ...
                    jnp.swapaxes(
                        jnp.swapaxes(
                            jnp.swapaxes(
                                gaussian_grid_spacing1
                                * jnp.resize(
                                    couplets.at[6::8].get(), (gaussP, gaussP, gaussP, N)
                                ),
                                3,
                                2,
                            ),
                    ...
                    jnp.swapaxes(
                        jnp.swapaxes(
                            jnp.swapaxes(
                                gaussian_grid_spacing1
                                * jnp.resize(
                                    couplets.at[7::8].get(), (gaussP, gaussP, gaussP, N)
                                ),
                                3,
                                2,
                            ),
        ...
        reshaped_array = jnp.zeros(11 * N)
        reshaped_array = reshaped_array.at[: 3 * N].set(
            jnp.reshape(w_lin_velocities, 3 * N)
        )
        reshaped_array = reshaped_array.at[3 * N :].set(
            jnp.reshape(ang_vel_and_strain, 8 * N)
        )
    ...
    def helper_Mpsi(random_array_real):
        ...
        couplets = jnp.zeros(8 * N)
        couplets = couplets.at[::8].set(
            random_array_real.at[(3 * N + 3) :: 8].get()
        )  # C[0] = S[0]
        couplets = couplets.at[1::8].set(
    ...
    R_FU12psi_correct = jnp.dot(sqrt_R_FU, random_array * np.sqrt(2.0 * kT / dt))
...
def convert_to_generalized(
    N, ws_lin_vel, rs_lin_vel, ws_ang_vel_strain, rs_ang_vel_strain
):
