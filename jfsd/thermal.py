...
def compute_wave_space_slipvelocity(
        ...
        gaussian_grid_spacing2: float) -> tuple:
...
def compute_nearfield_brownianforce(
    ...
    def Precondition_Inn_kernel( ###
            x: float,
            diagonal_zeroes_for_brownian: int) -> tuple:
...
# kwt debug: 'exact' computation of square root of mobility and resistance matrices
