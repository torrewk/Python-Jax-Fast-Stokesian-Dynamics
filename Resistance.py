...
def RFU_Precondition(
        ...
        # print(R_fu_precondition[(6*4):(6*4)+3,(6*4):(6*4)+3])   #A11
        # print(R_fu_precondition[(6*21):(6*21)+3,(6*21):(6*21)+3])  #A22
        
        # print(R_fu_precondition[(6*4)+3:(6*4)+6,(6*4)+3:(6*4)+6])  #C11
        # print(R_fu_precondition[(6*21)+3:(6*21)+6,(6*21)+3:(6*21)+6])  #C22
        
        
        # print(R_fu_precondition[(6*4):(6*4)+3,(6*4)+3:(6*4)+6])  #Bt11
        # print(R_fu_precondition[(6*4)+3:(6*4)+6,(6*4):(6*4)+3])  #B11

        # print(R_fu_precondition[(6*21):(6*21)+3,(6*21)+3:(6*21)+6])  #Bt22
        # print(R_fu_precondition[(6*21)+3:(6*21)+6,(6*21):(6*21)+3])  #B22
        
        # print(R_fu_precondition[(6*4):(6*4)+3,(6*21):(6*21)+3])   #A12
        # print(R_fu_precondition[(6*4)+3:(6*4)+6,(6*21)+3:(6*21)+6])   #C12
        # print(R_fu_precondition[(6*4):(6*4)+3,(6*21)+3:(6*21)+6])   #Bt12
        # print(R_fu_precondition[(6*4)+3:(6*4)+6,(6*21):(6*21)+3])   #B12
        
        # debug_m = jnp.zeros((12,12))
        # debug_m = debug_m.at[0:3,0:3].set(R_fu_precondition[(6*4):(6*4)+3,(6*4):(6*4)+3])
        # debug_m = debug_m.at[3:6,3:6].set(R_fu_precondition[(6*4)+3:(6*4)+6,(6*4)+3:(6*4)+6])
        # debug_m = debug_m.at[0:3,3:6].set(R_fu_precondition[(6*4)+3:(6*4)+6,(6*4)+3:(6*4)+6])
        ...
        # Debug (positive definite matrix)
        # a,b = jnp.linalg.eigh(R_fu_precondition)
        # print(a)

        # Vector of 0 (if has particle has no neigh) nad ones (elsewhere): needed later for brownian calculations, to perform Lanczos decomposition and square root
        diagonal_zeroes_for_brownian = diagonal_elements # compress diagonal elements
        ...
        return R_fu_precondition, diagonal_elements_for_brownian, diagonal_zeroes_for_brownian
...
def ComputeLubricationFU(velocities,
    ...
    # YC12 = ResFunctions[9]
    # YB21 = ResFunctions[10]
    # print(XA11,YA11,XA12,YA12,YB11,YB12,XC11,YC11,XC12,YC12,YB21)
...
def compute_RFE(N,shear_rate,r_lub,indices_i_lub,indices_j_lub,XG11,XG12,YG11,YG12,YH11,YH12):
